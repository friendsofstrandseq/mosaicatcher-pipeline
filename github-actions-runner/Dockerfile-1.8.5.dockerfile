...
#   prefix: /conda-envs/cf482507aa21d273978625572f6c0dae
#   name: rtools
#   channels:
#     - conda-forge
#     - bioconda
...
#   # # - r-r.utils
#   # # - r-ggnewscale
RUN mkdir -p /conda-envs/cf482507aa21d273978625572f6c0dae
COPY workflow/envs/rtools.yaml /conda-envs/cf482507aa21d273978625572f6c0dae/environment.yaml

# Conda environment:
#   source: workflow/envs/sv_heatmap.yaml
#   prefix: /conda-envs/289c96e6aba033663af92cfcaeda46d6
#   name: sv_heatmap
#   channels:
#     - conda-forge
#     - bioconda
...
#     - r-rcolorbrewer
#     - r-reshape2
RUN mkdir -p /conda-envs/289c96e6aba033663af92cfcaeda46d6
COPY workflow/envs/sv_heatmap.yaml /conda-envs/289c96e6aba033663af92cfcaeda46d6/environment.yaml
...
RUN mamba env create --prefix /conda-envs/eaec0caeb9cd1c6528bcf6100a284dfc --file /conda-envs/eaec0caeb9cd1c6528bcf6100a284dfc/environment.yaml && \
    ...
    mamba env create --prefix /conda-envs/cf482507aa21d273978625572f6c0dae --file /conda-envs/cf482507aa21d273978625572f6c0dae/environment.yaml && \
    mamba env create --prefix /conda-envs/289c96e6aba033663af92cfcaeda46d6 --file /conda-envs/289c96e6aba033663af92cfcaeda46d6/environment.yaml && \
    mamba clean --all -y
